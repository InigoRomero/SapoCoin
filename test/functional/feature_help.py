...
"""Verify that starting sapocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sapocoin with -h for help text")
        ...
        self.log.info("Start sapocoin with -version for version information")
        ...
        self.log.info("Start sapocoind with -fakearg to make sure it does not start")
