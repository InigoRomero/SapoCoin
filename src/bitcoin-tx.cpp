...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sapocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sapocoin-tx [options] <hex-tx> [commands]  Update hex-encoded sapocoin transaction\n" +
            "or:     sapocoin-tx [options] -create [commands]   Create hex-encoded sapocoin transaction\n" +
            "\n";
