# Support for Output Descriptors in SapoCoin Core

Since SapoCoin Core v0.17, there is support for Output Descriptors. This is a
...
on SapoCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing SapoCoin Core wallets, a convenience function `combo` is
