...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.sapocoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.sapocointools.com");
        vSeeds.emplace_back("dnsseed.sapocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.sapocointools.com");
        vSeeds.emplace_back("seed-b.sapocoin.loshan.co.uk");
