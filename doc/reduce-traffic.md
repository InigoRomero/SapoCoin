...
By default, SapoCoin Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that sapocoin's trustless model works best if you are
