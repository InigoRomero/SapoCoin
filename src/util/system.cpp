...
const char * const BITCOIN_CONF_FILENAME = "sapocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SapoCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SapoCoin";
#else
    // Unix
    return pathRet / ".sapocoin";
#endif
#endif
}
